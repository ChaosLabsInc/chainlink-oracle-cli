...
const { targetKey } = utils_1.default;
module.exports = {
    QUESTION_NAMES: QUESTION_PROMPT_NAMES,
    getConfigurablePriceFeedsQuestion: function getConfigurablePriceFeedsQuestion(choices) {
        return [
            {
                type: "rawlist",
    ...
    getAllPriceFeedsQuestion: function getAllPriceFeedsQuestion(tokenPairsSliced) {
        return [
            {
                type: "rawlist",
                name: QUESTION_PROMPT_NAMES.CONFIGURABLE_FEEDS,
    ...
    showAllPriceFeedsSelected: function showAllPriceFeedsSelected(pairSelectionParsed) {
        return targetKey(pairSelectionParsed) == "6";
    },
    showSearchPriceFeedsSelected: function showSearchPriceFeedsSelected(pairSelectionParsed) {
